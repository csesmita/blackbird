...
#define  NW  100                //Number of workers (total number of workers in the cluster)
#define  NM  10                  //Number of masters (i.e., the total number of groups/masters in the cluster)
...
#define INPUT_FILE_NAME "../../temp.tr"
#define OUTPUT_FILE_NAME "pigeon_results"
